...
当前自动分期主逻辑已同步为审校后的肺癌 TNM 第9版内容，并配套更新为当前正式版所采用的 NSCLC / SCLC 路径呈现方式。
...
- 已将 README 中的临床依据表述同步更新为当前正式版采用的 TNM 第9版定位
- 已将项目说明与最新双语单文件 HTML 交付版本保持一致
- 已补充 v1.2.0 对 NSCLC / SCLC 分期、路径提示与随访建议内容更新的说明
